// Combo: All simple no-IRQ mappers (002+003+007+011+066+070+078+093+097)  ~180 LEs est.
...
begin
   ...
   begin
      ...
      begin
         ...
         // Mapper #93 - Sunsoft-2
         if (1 && (mapper == 6'b000101))
         begin
            prg_bank_a[3:1] <= {cpu_data_in[6:4]};
            chr_write_enabled <= cpu_data_in[0];
         end

         if (1 && (mapper == 6'b000100))
         begin
