module Cool2Poor # (
	parameter ENABLE_MAPPER_001 = 1,             // mapper #001 - MMC1
	...
	parameter ENABLE_MAPPER_021_022_023_025 = 0, // mappers #021, #022, #023, #025 - VRC2, VRC4
	parameter ENABLE_MAPPER_022 = 0,             // mapper #022 - VRC2a (shifted CHR lines)
	parameter ENABLE_VRC4_INTERRUPTS = 0,        // VRC4 interrupts
	parameter ENABLE_MAPPER_030 = 0,             // mapper #030 - add UNROM512 features to UxROM, require ENABLE_MAPPER_002
	parameter ENABLE_MAPPER_032 = 0,             // mapper #032 - Irem's G101
	parameter ENABLE_MAPPER_033_048 = 0,         // mappers #033 & #048 - Taito
	parameter ENABLE_MAPPER_048_INTERRUPTS = 0,  // mapper #048 interrupts
	parameter ENABLE_MAPPER_034_BNROM = 0,       // mapper #034 (BNROM only)
	parameter ENABLE_MAPPER_036 = 0,             // mapper #036 - TXC's PCB 01-22000-400
	parameter ENABLE_MAPPER_038 = 0,             // mapper #038: Crime Busters
	parameter ENABLE_MAPPER_042 = 0,             // mapper #042 - FDS conversions
	parameter ENABLE_MAPPER_042_INTERRUPTS = 0,  // mapper #042 interrupts: for Mario Baby only
	parameter ENABLE_MAPPER_065 = 0,             // mapper #065 - Irem's H3001
	parameter ENABLE_MAPPER_066 = 0,             // mapper #066 - GxROM
	parameter ENABLE_MAPPER_067 = 0,             // mapper #067 - Sunsoft-3
	parameter ENABLE_MAPPER_069 = 0,             // mapper #069 - Sunsoft FME-7
	parameter ENABLE_MAPPER_070_152 = 0,         // mappers #070, #152
	parameter ENABLE_MAPPER_071 = 1,             // mapper #071 - Camerica: for Fire Hawk only, require ENABLE_MAPPER_002
	parameter ENABLE_MAPPER_073 = 0,             // mapper #073 - VRC3
	parameter ENABLE_MAPPER_075 = 0,             // mapper #075 - VRC1
	parameter ENABLE_MAPPER_078 = 0,             // mapper #078 - Irem: Holy Diver and Uchuusen - Cosmo Carrier
	...
	parameter ENABLE_MAPPER_087 = 0,             // mapper #087 - Jaleco
	parameter ENABLE_MAPPER_089 = 0,             // mapper #089 - Sunsoft-2 chip on the Sunsoft-3 board: Mito Koumon
	parameter ENABLE_MAPPER_090 = 0,             // mapper #090 - JY (partical support): Aladdin only
	...
	parameter ENABLE_MAPPER_093 = 0,             // mapper #093 - Sunsoft-2: Shanghai, Fantasy Zone
	...
	parameter ENABLE_MAPPER_118 = 0,             // mapper #118 - TxSROM
	...
	parameter ENABLE_MAPPER_189 = 0,             // mapper #189 - TXC
	...
	parameter UxROM_BITSIZE = 3,                 // Maximum size for UxROM PRG (3=256KB - standard size, 4=512KB - required for some hacks/homebrew)
	parameter AxROM_BxROM_BITSIZE = 2,           // Maximum size for AxROM/BxROM PRG (2=256KB - standard size, 3=512KB - required for some hacks/homebrew)
	parameter MMC3_BITSIZE = 6,                  // Maximum size for MMC3 PRG (6=512KB - standard size, 8=2MB - required for some hacks/homebrew)

	parameter RESET_COMBINATION = 8'b0           // Set to 0, because reset use 80 logic elements!
...
begin
   ...
   begin
      ...
      begin
         ...
         if (ENABLE_MAPPER_002 && (mapper == 6'b000001))
         begin
         ...
         // Mapper #3 - CNROM
         if (ENABLE_MAPPER_003 && (mapper == 6'b000010))
         begin
         ...
         // Mapper #7 - AxROM
         if (ENABLE_MAPPER_007 && (mapper == 6'b001000))
         begin
         ...
         */
         if (ENABLE_MAPPER_001 && (mapper == 6'b010000))
         begin
...
//                        end
         ...
         */
         if (ENABLE_MAPPER_004 && (mapper == 6'b010100))
         begin
